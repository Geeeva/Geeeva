                ...
                <div className="icon-wrapper">
                    <a href="https://github.com/Geeeva" target="_blank" rel="noopener noreferrer">
                        <div className="github-wrapper">
                            ...
                            <path fill="#8F817E" d="M15,22.8v-3.3c0-1.1-0.4-1.9-0.8-2.2c2.7-0.3,5.5-1.3,5.5-5.9c0-1.3-0.5-2.4-1.2-3.2
                    ...
                    <a href="https://www.linkedin.com/in/ivana-gili%C4%87-04620850/" target="_blank" rel="noopener noreferrer">
                        <div className="linkedin-wrapper">
                            ...
                            <svg id="linkedin" viewBox="0 0 24 24">
                                <path fill="#8F817E" d="M8,19H5V8h3V19z M6.5,6.7c-1,0-1.8-0.8-1.8-1.8s0.8-1.8,1.8-1.8S8.3,4,8.3,5S7.5,6.7,6.5,6.7z M20,19h-3
